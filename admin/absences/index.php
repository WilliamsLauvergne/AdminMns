...
<link rel="stylesheet" href="/assets/css/style_admin/style_admin_absences/style_admin_absences_index.css">
            ...
            <tbody>
                <?php foreach ($absences as $absence) : ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($absence['document'] != null) : ?>
                                <a href="download.php?id=<?php echo $absence['document']; ?>">Télécharger</a>
                            <?php else : ?>
                                Aucun document
                            <?php endif; ?>
                        </td>
